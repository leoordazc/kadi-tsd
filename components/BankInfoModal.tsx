...
export default function BankInfoModal({ isOpen, onClose, total }: BankInfoModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm" onClick={onClose}>
      ...
      >
        <h3 className="text-xl font-light mb-4">💸 Transferencia BBVA (Nombre:Leonardo Farid O. C.)</h3>
        ...
        <p className="text-xs text-white/30 mt-4">
          Realiza la transferencia y envía el comprobante, tu nombre y la pieza adquirida para confirmar tu pedido.
        </p>
        ...
        <div className="flex flex-col gap-3 mt-4">
          {/* Botón Gmail */}
          <a
            href={`mailto:ventas.kaditsd@gmail.com.mx?subject=Pago KADI - Referencia ${referencia}&body=Hola,%20adjunto%20el%20comprobante%20de%20transferencia.%0A%0AMi%20nombre:%20%0APieza%20adquirida:%20%0AReferencia:%20${referencia}%0ATotal:%20$${total.toLocaleString()}`}
